...
\ustcsetup{
  title              = {分布式对象存储系统AliIO的管理控制平台的设计与实现},
  title*             = {Design and implementation of management control platform for distributed object storage system AliIO},
  author             = {张华星},
  author*            = {Zhang Huaxing},
  speciality         = {软件工程},
  speciality*        = {Software Engineering},
  supervisor         = {金革教授},
  supervisor*        = {Prof. Jin Ge},
  advisor            = {彭本华},
  advisor*           = {Peng Benhua},
